...
const InputInventaris = () => {
  ...
  //Untuk Dropdown Input Jenis Anggaran
  const handleJenisAnggaranChange = (jenis_anggaran) => {
    setData({
      ...data,
  ...
  //Untuk Dropdown Input Jenis Anggaran
  const handleSubAnggaranChange = (sub_anggaran) => {
    setData({
      ...data,
  ...
  //Untuk Date Picker
  const handleTanggalPengadaanChange = (date) => {
    setData((prevData) => ({
      ...prevData,
  ...
  const handleBuktiPengadaanChange = (e) => {
    const file = e.target.files[0];
    setData((prevData) => ({
      ...prevData,
      bukti_pengadaan: file,
    }));
  };
            ...
            <div id="DashboardContent" className="flex flex-row">
              <div className="flex flex-col bg-gray-100 w-full h-screen pt-20 px-4">
                <p className="font-sm text-gray-600 mt-2 mb-3">
                  Masukkan Jenis Kegiatan Terlebih Dahulu
                </p>
                <div
                  id="LeftBoxParent"
                      ...
                      <div id="LeftBoxParent" className="w-[60%] space-y-6">
                        ...
                        <div id="SecondData">
                          <div className="flex w-full space-x-6 h-[12%]">
                            ...
                            <div className="w-[50%]">
                              <InputJenisAnggaran
                                value={data.jenis_anggaran}
                                onChange={handleJenisAnggaranChange}
                              />
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="flex w-full space-x-6 h-[12%]">
                            <div className="w-[50%]">
                              <InputTanggalPengadaan
                                selectedDate={data.tanggal_pengadaan}
                                onDateChange={handleTanggalPengadaanChange}
                              />
                            </div>
                            <div className="w-[50%]">
                              <InputSubAnggaran
                                value={data.sub_anggaran}
                        ...
                        <div id="FourthData">
                          <div className="flex w-full space-x-6 h-[12%]">
                            ...
                            <div className="w-[50%]">
                              <InputBuktiPengadaan
                                onChange={handleBuktiPengadaanChange}
                              />
                            </div>
                          </div>
                        </div>
